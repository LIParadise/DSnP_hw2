...
set shortmess=aoO
badd +104 cmdCharDef.h
badd +0 cmdParser.h
badd +0 cmdReader.cpp
badd +19 cmdCharDef.cpp
argglobal
silent! argdel *
argadd cmdCharDef.h
set stal=2
...
silent! normal! zE
let s:l = 114 - ((14 * winheight(0) + 19) / 39)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 171 - ((5 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
171
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 209 - ((14 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
209
